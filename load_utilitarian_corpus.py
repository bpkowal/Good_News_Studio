...
def load_utilitarian_corpus(required_tag=None):
    embedder = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")
    vectorstore = Chroma(collection_name="utilitarian_ethics", embedding_function=embedder)

    corpus_path = Path("utilitarian_corpus")
    count_loaded = 0
