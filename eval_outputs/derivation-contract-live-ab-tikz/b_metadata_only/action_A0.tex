...
\node[neutral] (eE1B) at (5.2,0.0) {\textbf{E1B}\\the medicine is not given to Maria\\\scriptsize dose of medicine · NEUTRAL · CERTAIN\\\scriptsize source: C6, C0};
\node[neutral] (eE1C) at (10.4,0.0) {\textbf{E1C}\\Maria does not receive the medicine\\\scriptsize Maria · NEUTRAL · CERTAIN\\\scriptsize source: C0};
\node[adverse] (eE2) at (15.600000000000001,0.0) {\textbf{E2}\\Maria dies\\\scriptsize Maria · ADVERSE · CERTAIN\\\scriptsize source: C3};
\draw[causal] (eE1) -- node[above,font=\scriptsize] {CAUSES} (eE1B);
\draw[causal] (eE1B) -- node[above,font=\scriptsize] {CAUSES} (eE1C);
\draw[causal] (eE1C) -- node[above,font=\scriptsize] {CAUSES} (eE2);
\end{tikzpicture}
\end{document}
