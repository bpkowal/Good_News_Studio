...
\node[neutral] (eE3B) at (5.2,0.0) {\textbf{E3B}\\the medicine is not given to David\\\scriptsize dose of medicine · NEUTRAL · CERTAIN\\\scriptsize source: C6, C0};
\node[neutral] (eE3C) at (10.4,0.0) {\textbf{E3C}\\David does not receive the medicine\\\scriptsize David · NEUTRAL · CERTAIN\\\scriptsize source: C0};
\node[adverse] (eE4) at (15.600000000000001,0.0) {\textbf{E4}\\David dies\\\scriptsize David · ADVERSE · CERTAIN\\\scriptsize source: C4};
...
\draw[causal] (eE3) -- node[above,font=\scriptsize] {CAUSES} (eE3B);
\draw[causal] (eE3B) -- node[above,font=\scriptsize] {CAUSES} (eE3C);
\draw[causal] (eE3C) -- node[above,font=\scriptsize] {CAUSES} (eE4);
