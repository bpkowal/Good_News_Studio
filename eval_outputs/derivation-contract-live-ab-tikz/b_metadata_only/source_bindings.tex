...
\node[event] (eE1B) at (8,-1.8) {\textbf{E1B} the medicine is not given to Maria};
\draw[binding] (cC6) -- (eE1B);
\draw[binding] (cC0) -- (eE1B);
\node[event] (eE1C) at (8,-3.6) {\textbf{E1C} Maria does not receive the medicine};
\draw[binding] (cC0) -- (eE1C);
\node[event] (eE2) at (8,-5.4) {\textbf{E2} Maria dies};
\draw[binding] (cC3) -- (eE2);
\node[event] (eE3) at (8,-7.2) {\textbf{E3} Maria receives the medicine};
\draw[binding] (cA1) -- (eE3);
\draw[binding] (cC6) -- (eE3);
\draw[binding] (cC0) -- (eE3);
\node[event] (eE3B) at (8,-9.0) {\textbf{E3B} the medicine is not given to David};
\draw[binding] (cC6) -- (eE3B);
\draw[binding] (cC0) -- (eE3B);
\node[event] (eE3C) at (8,-10.8) {\textbf{E3C} David does not receive the medicine};
\draw[binding] (cC0) -- (eE3C);
\node[event] (eE4) at (8,-12.6) {\textbf{E4} David dies};
\draw[binding] (cC4) -- (eE4);
\node[event] (eE5) at (8,-14.4) {\textbf{E5} Maria has a slightly better chance of survival};
