...
def load_virtue_ethics_corpus(required_tag=None):
    embedder = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")
    vectorstore = Chroma(collection_name="virtue_ethics", embedding_function=embedder)

    corpus_path = Path("virtue_ethics_corpus")
    count_loaded = 0
    ...
    print(f"✅ Loaded {count_loaded} virtue ethics corpus file(s) into Chroma.")
    return vectorstore
