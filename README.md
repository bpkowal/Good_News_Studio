...
├── scenario_builder_general.py   # Scenario builder
├── [agent scripts]               # Utilitarian, Deontology, Virtue, Care, etc.
├── deontological_corpus/         # Corpus for deontological agent
...
## Liscence
   ...
   APPENDIX: How to apply the Apache License to your work.
      ...
      comment style for the file format. We also recommend that a
      file or class name and description of purpose be included on the
      same "printed page" as the copyright notice for easier
      identification within third-party archives.

   Copyright 2025 Benjamin Kowal
